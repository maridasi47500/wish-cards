...
class PicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pic" do
    assert_difference("Pic.count") do
      post pics_url, params: { pic: { filename: @pic.filename, height: @pic.height, width: @pic.width, x: @pic.x, y: @pic.y } }
    end
  ...
  test "should update pic" do
    patch pic_url(@pic), params: { pic: { filename: @pic.filename, height: @pic.height, width: @pic.width, x: @pic.x, y: @pic.y } }
