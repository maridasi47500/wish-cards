...
class TextsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create text" do
    assert_difference("Text.count") do
      post texts_url, params: { text: { color: @text.color, content: @text.content, message_id: @text.message_id, size: @text.size, weight: @text.weight } }
    end
  ...
  test "should update text" do
    patch text_url(@text), params: { text: { color: @text.color, content: @text.content, message_id: @text.message_id, size: @text.size, weight: @text.weight } }
